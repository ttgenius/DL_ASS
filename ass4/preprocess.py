...
def pad_english_corpus(english):
    ...
    for i, line in enumerate(english):
        ...
        #if i < 4:
            #print("english padded sentence",  ENGLISH_padded_sentences)
...
def pad_french_corpus(french):
    ...
    for i, line in enumerate(french):
        ...
        #if i < 4:
            #print("french padded sentence",  FRENCH_padded_sentences)
