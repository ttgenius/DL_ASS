...
def train(model, train_french, train_english, optimizer, batch_size=128, input_vocab=None, output_vocab=None,
          debug=True, test=None):
    """
...
def main():
    ...
    train_short_french, train_short_english, _, _ = get_part2_data('data/fls_short.txt', 'data/els_short.txt',
